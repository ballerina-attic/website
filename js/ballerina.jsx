...
$(document).ready(function() {
    ...
    var menu = '<div class="container"> <nav class="navbar navbar-default"> <div class="container-fluid"> <div class="navbar-header"> <button type="button" class="navbar-toggle collapsed" data-toggle="collapse" data-target="#navbar" aria-expanded="false" aria-controls="navbar"> <span class="sr-only">Toggle navigation</span> <span class="icon-bar"></span> <span class="icon-bar"></span> <span class="icon-bar"></span> </button> <a class="navbar-brand" href="http://ballerinalang.org/"><img src="http://ballerinalang.org/img/ballerina-logo.svg"/></a> </div> <div id="navbar" class="navbar-collapse collapse" aria-expanded="false" style="height: 1px;"> <ul class="nav navbar-nav"> <li><a href="http://ballerinalang.org/docs">Documentation</a></li> <li><a href="http://ballerinalang.org/#Getting-Started">Getting Started</a></li> <li><a href="http://ballerinalang.org/#Get-involved">Get involved</a></li> <li><a href="https://medium.com/@ballerinalang/why-ballerina-c0822e81bb87" target=_blank>Blog</a></li> </ul> </div> </div> </nav> </div>';

    var footer = '<div class="container"> <ul> <li>©2017 WSO2</li> <li><a href="http://ballerinalang.org/terms-of-use">Terms of Use</a></li> <li><a href="http://ballerinalang.org/privacy-policy">Privacy Policy</a></li> </ul> <ul class="cPowerdby"><li>Powered by<a href="http://wso2.com/"><img src="http://ballerinalang.org/img/wso2logo_white.svg"/></a></li></ul></div>';
